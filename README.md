...
Complete evaluation data with all mask types and methods: [evaluation_all_methods_20260224_081951.json](evaluation_all_methods_20260224_081951.json)

### Sample Inpainting Results

Below are sample inpainting results comparing three different methods:

#### Method 1: Vanilla without Text
Standard DDPM inpainting with no text guidance.

| Sample 1 | Sample 2 | Sample 3 |
|----------|----------|----------|
| ![Sample 1](our_images/our_Inpainting/Vanilla_without_text/inpainted_images/1_inpainted.png) | ![Sample 2](our_images/our_Inpainting/Vanilla_without_text/inpainted_images/2_inpainted.png) | ![Sample 3](our_images/our_Inpainting/Vanilla_without_text/inpainted_images/3_inpainted.png) |

#### Method 2: Vanilla with General Text
DDPM inpainting with a generic text prompt applied to all images.

| Sample 1 | Sample 2 | Sample 3 |
|----------|----------|----------|
| ![Sample 1](our_images/our_Inpainting/Vanilla_with_general_text/inpainted_images/1_inpainted.png) | ![Sample 2](our_images/our_Inpainting/Vanilla_with_general_text/inpainted_images/2_inpainted.png) | ![Sample 3](our_images/our_Inpainting/Vanilla_with_general_text/inpainted_images/3_inpainted.png) |

#### Method 3: Vanilla with Generated Text (LLaVA)
DDPM inpainting with image-specific prompts generated by LLaVA.

| Sample 1 | Sample 2 | Sample 3 |
|----------|----------|----------|
| ![Sample 1](our_images/our_Inpainting/Vanilla_with_generated_text/inpainted_images/1_inpainted.png) | ![Sample 2](our_images/our_Inpainting/Vanilla_with_generated_text/inpainted_images/2_inpainted.png) | ![Sample 3](our_images/our_Inpainting/Vanilla_with_generated_text/inpainted_images/3_inpainted.png) |
